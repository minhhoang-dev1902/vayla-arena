...
export function PrevButton(props: PrevNextButtonPropType) {
	...
	return (
		...
		>
			<svg className="embla__button__svg" viewBox="137.718 -1.001 366.563 644" fill="currentColor">
...
export function NextButton(props: PrevNextButtonPropType) {
	...
	return (
		...
		>
			<svg className="embla__button__svg" viewBox="0 0 238.003 238.003" fill="currentColor">
