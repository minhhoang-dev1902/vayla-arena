			...
			<div className="relative mx-4 w-full max-w-lg rounded-2xl bg-[#0c1e2e] p-6 shadow-2xl">
				...
				{!isSelected && canSelect && (
					<button
						...
						className="mt-5 w-full rounded-full bg-primary py-3.5 text-sm font-extrabold uppercase tracking-wider text-white transition active:scale-[0.97]"
					>
						Select This Song
					</button>
				)}
				...
				{isSelected && (
					<div className="mt-5 w-full rounded-full bg-primary py-3.5 text-center text-sm font-extrabold uppercase tracking-wider text-white opacity-60">
						Already Selected
					</div>
				)}
			</div>
...
function SelectedTrackItem({
	...
	return (
		<li
			...
			className="flex items-center gap-3 rounded-[28px] border-2 border-primary bg-white px-4 py-3.5"
		>
			<span className="inline-flex size-10 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-extrabold text-white">
				{ordinalLabel(voteRank)}
			</span>
			<button
				type="button"
				onClick={onPlay}
				className="inline-flex size-9 shrink-0 items-center justify-center rounded-full border-2 border-primary bg-white text-primary transition hover:scale-105"
			>
									...
									<li key={track.id}>
										...
										>
											...
											<button
												...
												className="inline-flex size-9 shrink-0 items-center justify-center rounded-full border border-[#e2e8f0] text-[#cbd5e1] transition hover:border-primary hover:text-primary"
											>
												<Play className="ml-0.5 size-3.5 fill-current" />
											</button>
											<div className="min-w-0 flex-1">
